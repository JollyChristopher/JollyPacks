advancement revoke @s only bloomin_town:recipes/recipe_rabbit_pen

execute as @e[tag=nitKSitePlanner,limit=1,sort=nearest,distance=..3] at @s if entity @s[tag=nitSiteEast] run setblock ~ ~1 ~ minecraft:structure_block{ignoreEntities:0b,rotation:"NONE",posX:1,mode:"LOAD",posY:-4,sizeX:15,posZ:-7,integrity:1.0f,name:"bloomin_town:town/rabbit_pen",sizeY:32,sizeZ:15} replace
...
execute as @e[tag=nitKSitePlanner,limit=1,sort=nearest,distance=..3] at @s if entity @s[tag=nitSiteWest] run setblock ~ ~1 ~ minecraft:structure_block{ignoreEntities:0b,rotation:"NONE",posX:-15,mode:"LOAD",posY:-4,sizeX:15,posZ:-7,integrity:1.0f,name:"bloomin_town:town/rabbit_pen",sizeY:32,sizeZ:15} replace
...
execute as @e[tag=nitKSitePlanner,limit=1,sort=nearest,distance=..3] at @s if entity @s[tag=nitSiteNorth] run setblock ~ ~1 ~ minecraft:structure_block{ignoreEntities:0b,rotation:"NONE",posX:-7,mode:"LOAD",posY:-4,sizeX:15,posZ:-15,integrity:1.0f,name:"bloomin_town:town/rabbit_pen",sizeY:32,sizeZ:15} replace
...
execute as @e[tag=nitKSitePlanner,limit=1,sort=nearest,distance=..3] at @s if entity @s[tag=nitSiteSouth] run setblock ~ ~1 ~ minecraft:structure_block{ignoreEntities:0b,rotation:"NONE",posX:-7,mode:"LOAD",posY:-4,sizeX:15,posZ:1,integrity:1.0f,name:"bloomin_town:town/rabbit_pen",sizeY:32,sizeZ:15} replace
